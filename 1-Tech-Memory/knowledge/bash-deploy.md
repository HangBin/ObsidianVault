...
### 强关联
- [[backup-system]] - 备份系统开发遵循Bash最佳实践
- [[2026-04-04]] - 服务迁移标准化
- [[2026-04-05]] - 每日记忆管理系统脚本开发

### 中关联
- [[docker-compose]] - Docker部署脚本也遵循Bash规范
- [[memory-system]] - 记忆归档脚本使用Bash开发
- [[mission-control-dashboard]] - Mission Control部署脚本

### 弱关联
- [[2026-03-27]] - 配置文件优化涉及脚本开发
- [[2026-04-28]] - 同步脚本开发（sync-daily-to-obsidian.sh）
