...
### 强关联
- [[bash-deploy]] - 备份系统使用Bash脚本开发
- [[2026-03-31]] - 备份体系重构（核心成就）
- [[2026-04-05]] - 每日记忆管理系统上线（含备份整合）

### 中关联
- [[memory-system]] - 记忆归档流程依赖备份系统
- [[collaboration-patterns]] - 多工作区备份需要协作模式支持

### 弱关联
- [[docker-compose]] - Docker容器也需要备份策略
- [[2026-03-26]] - 跨session通信涉及备份通道
